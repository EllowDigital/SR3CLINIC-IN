    ...
    services: [
      {
        ...
        detail:
          "Minimally invasive procedures using HD endoscopes for accurate diagnosis and treatment.",
      },
      {
        name: "Tonsil & Adenoid Treatments",
        detail:
          "Tonsillectomy, adenoidectomy, and treatment for recurrent throat infections.",
      },
      {
        name: "Thyroid & Salivary Gland Surgeries",
        detail:
          "Expert surgical management of thyroid nodules, goitre, and salivary gland disorders.",
      },
      {
        name: "Head, Neck, Oral & Throat Cancer Care",
        detail:
          "Early detection, biopsy, and multidisciplinary surgical management of head and neck cancers.",
      },
      {
        name: "Audiometry (Hearing Tests) & Hearing Aids",
        detail:
          "Comprehensive hearing assessment, audiogram interpretation, and custom hearing aid fitting.",
      },
    ],
  },
  {
    ...
    services: [
      {
        name: "Laparoscopic & Open Surgeries",
        detail:
          "Keyhole surgery for gallbladder, appendix, and abdominal conditions with rapid recovery.",
      },
      {
        name: "Gallbladder, Appendix, Hernia & Prostate",
        detail:
          "Definitive surgical treatment for common and complex abdominal conditions.",
      },
      {
        name: "Laser & Ksharsutra for Piles, Fissure, Fistula",
        detail:
          "Pain-free, daycare laser procedures and traditional Ksharsutra therapy for anorectal conditions.",
      },
      {
        name: "Kidney Stone & Tumor Surgeries",
        detail:
          "Minimally invasive urological procedures for stones, cysts, and benign tumors.",
      },
    ],
  },
  {
    ...
    services: [
      {
        name: "Cesarean Delivery & Pregnancy Care",
        detail:
          "Comprehensive antenatal, intrapartum, and postnatal care for safe and healthy deliveries.",
      },
      {
        name: "Infertility Treatment & Menstrual Disorders",
        detail:
          "Evidence-based assessment and treatment for infertility, PCOS, endometriosis, and irregular cycles.",
      },
      {
        name: "Uterine Tumor Surgeries",
        detail:
          "Minimally invasive myomectomy and hysterectomy for fibroids and uterine tumors.",
      },
    ],
  },
  {
    ...
    services: [
      {
        name: "Advanced Physiotherapy (Neck, Back, Knee)",
        detail:
          "Evidence-based physiotherapy for musculoskeletal pain, sports injuries, and post-operative rehabilitation.",
      },
      {
        name: "Diet & Nutritional Counseling",
        detail:
          "Personalised nutrition planning for weight management, diabetes, post-surgery recovery, and chronic conditions.",
      },
      {
        name: "Blood Tests, BP/Sugar Monitoring & Nebulization",
        detail:
          "On-site pathology, routine monitoring services, and respiratory nebulization therapy.",
      },
    ],
  },
];
  ...
  return (
    <div className="border border-gray-100 rounded-xl overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between px-5 py-4 bg-white hover:bg-clinical-white transition-colors text-left"
      >
      ...
      <div className="bg-navy pt-28 pb-16 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <h1 className="font-serif text-4xl md:text-5xl text-white leading-tight mb-4">
            Specialities{" "}
            <span className="text-gold-gradient">&amp; Doctors</span>
          </h1>
          ...
          <p className="font-sans text-white/55 text-base leading-relaxed max-w-2xl mx-auto">
            Our fellowship-trained specialists bring decades of combined
            experience to deliver precise, compassionate care across five
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {doctors.map((doc, i) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="font-serif text-xl text-navy mb-0.5">
                    {doc.name}
                  </h3>
                  <p className="text-gold text-xs font-sans font-semibold tracking-wide uppercase mb-2">
                    {doc.role}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {doc.specialties.map((s) => (
                      <span
                        key={s}
                        className="px-2.5 py-1 bg-gold/8 text-gold text-xs font-sans rounded-full border border-gold/15"
                      >
                        {s}
                      </span>
                    ))}
        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            {serviceTabs.map((t) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-full font-sans text-sm font-medium transition-all duration-200 ${isActive ? "gold-gradient text-navy shadow-md shadow-gold/20" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}
                >
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="grid md:grid-cols-5 gap-0 bg-clinical-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm"
            >
              {/* Image */}

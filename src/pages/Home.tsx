...
const services = [
  {
    icon: Ear,
    title: "ENT & Head/Neck",
    items: ["Endoscopic Surgeries", "Tonsil & Adenoid", "Hearing Tests & Aids"],
    to: "/specialities",
  },
  {
    icon: Scissors,
...
const testimonials = [
  {
    name: "Rahul S.",
    role: "ENT Patient",
    text: "Dr. Samvartika diagnosed my chronic sinusitis accurately when three other doctors had missed it. The endoscopic treatment was painless. I highly recommend SR³.",
    stars: 5,
  },
  {
    name: "Priya V.",
    role: "Post-Surgery Patient",
    text: "I had my gallbladder removed laparoscopically by Dr. Vishwakarma. Minimal pain, discharged in 24 hours. The entire team was incredibly professional and caring.",
    stars: 5,
  },
  {
    name: "Sunita M.",
    role: "Maternity Patient",
    text: "Dr. Madhu Agrawal guided me through my high-risk pregnancy with exceptional care. I delivered safely and the staff were warm and attentive throughout.",
    stars: 5,
  },
  {
    name: "Ajay K.",
    role: "Physiotherapy Patient",
    text: "After two years of knee pain, Dr. Leena Verma's physiotherapy programme gave me my life back in just 6 weeks. Truly life-changing care.",
    stars: 5,
  },
];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center divide-y sm:divide-y-0 sm:divide-x divide-gold/15">
            {stats.map((s, i) => (
              ...
              >
                ...
                <div>
                  <p className="font-serif text-2xl text-gold font-bold leading-none">
                    {s.value}
                  </p>
                  <p className="text-white/55 font-sans text-xs mt-0.5 tracking-wide">
                    {s.label}
                  </p>
                </div>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="font-sans text-gray-500 max-w-xl mx-auto text-sm leading-relaxed">
              Five specialities, one address. Expert care from diagnosis to
              complete recovery.
            </p>
          </motion.div>
              ...
              >
                ...
                <ul className="space-y-1.5 mb-5">
                  {svc.items.map((item) => (
                    <li
                      key={item}
                      className="flex items-center gap-2 text-xs font-sans text-gray-500"
                    >
      ...
      <section ref={testimonialsRef} className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-navy leading-tight mb-4">
              Real <span className="text-gold-gradient">Success Stories</span>
            </h2>
            <div className="w-16 h-0.5 gold-gradient mx-auto mb-5" />
            <p className="font-sans text-gray-500 max-w-xl mx-auto text-sm leading-relaxed">
              The trust of thousands of families from Lucknow and across Uttar
              Pradesh is our greatest achievement.
            </p>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <p className="font-sans text-gray-600 leading-relaxed text-sm mb-6 italic">
                  "{t.text}"
                </p>
      ...
      <section className="py-20 bg-navy relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="font-sans text-white/55 text-sm leading-relaxed mb-8">
            Our specialists are available for OPD consultations, second
            opinions, and emergency care. Call us or book online.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="inline-flex items-center justify-center px-8 py-3.5 gold-gradient text-navy font-sans font-semibold text-sm rounded-full hover:opacity-90 transition-opacity shadow-lg shadow-gold/20"
            >
              Book Appointment
            </Link>
            <a
              href="tel:+919369643922"
              className="inline-flex items-center justify-center px-8 py-3.5 border border-gold/40 text-white font-sans font-medium text-sm rounded-full hover:border-gold hover:text-gold transition-colors"
            >
              Call +91 9369643922
            </a>
          </div>

...
const admissionSteps = [
  {
    ...
    desc: "Walk in or call ahead. Consult with our specialist who will diagnose your condition and recommend the appropriate treatment pathway.",
  },
  {
    step: "02",
    title: "Investigation & Reports",
    desc: "On-site blood tests, imaging, and diagnostic workup. Our team coordinates all investigations for a swift turnaround.",
  },
  {
    step: "03",
    title: "Pre-Admission Counselling",
    desc: "Our patient coordinator explains the procedure, estimated costs, insurance applicability, and answers all your questions.",
  },
  {
    step: "04",
    title: "Admission & Surgery Scheduling",
    desc: "Choose a convenient date. Our administrative team handles all paperwork, bed allocation, and pre-operative preparation.",
  },
  {
    step: "05",
    title: "Procedure & Recovery",
    desc: "Your procedure is performed in our state-of-the-art theatre. Our nursing team monitors you through recovery with round-the-clock care.",
  },
  {
    step: "06",
    title: "Discharge & Follow-up",
    desc: "Clear discharge instructions, prescribed medications, and a scheduled follow-up appointment to ensure complete recovery.",
  },
];
  ...
  return (
    <div className="border border-gray-100 rounded-xl overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between px-6 py-4 bg-white hover:bg-clinical-white transition-colors text-left gap-4"
      >
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <p className="px-6 pb-5 pt-2 font-sans text-gray-500 text-sm leading-relaxed border-t border-gray-100 bg-clinical-white">
              {a}
            </p>
          </motion.div>
        )}
      ...
      <div className="bg-navy pt-28 pb-16 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <h1 className="font-serif text-4xl md:text-5xl text-white leading-tight mb-4">
            Patient <span className="text-gold-gradient">Guide</span>
          </h1>
          ...
          <p className="font-sans text-white/55 text-base leading-relaxed max-w-2xl mx-auto">
            Everything you need to know about visiting SR³ — from your first
            appointment to complete recovery.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="font-sans text-gray-500 max-w-xl mx-auto text-sm leading-relaxed">
              We have made the admission process as seamless and transparent as
              possible so you can focus on what matters — your recovery.
            </p>
          </motion.div>
            ...
            <div className="space-y-8">
              {admissionSteps.map((s, i) => (
                ...
                >
                  {/* Step card */}
                  <div
                    className={`bg-clinical-white rounded-2xl p-7 border border-gray-100 shadow-sm ${i % 2 !== 0 ? "md:ltr" : ""}`}
                  >
                    <div className="flex items-center gap-4 mb-3">
                      <span className="text-4xl font-serif text-gold/30 font-bold leading-none">
                        {s.step}
                      </span>
      ...
      <section ref={insuranceRef} className="py-24 bg-clinical-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-navy leading-tight mb-4">
              Insurance &amp;{" "}
              <span className="text-gold-gradient">TPA Tie-ups</span>
            </h2>
            <div className="w-16 h-0.5 gold-gradient mx-auto mb-5" />
            <p className="font-sans text-gray-500 max-w-xl mx-auto text-sm leading-relaxed">
              SR³ is empanelled with all major health insurance providers and
              TPAs, ensuring a hassle-free cashless experience for our patients.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-navy rounded-2xl p-8 mb-10 flex flex-col md:flex-row items-center gap-6 border border-gold/15"
          >
            ...
            <div>
              ...
              <p className="font-sans text-white/55 text-sm leading-relaxed">
                Avail cashless treatment for planned surgeries and admissions.
                Our insurance desk handles pre-authorization, claim submission,
                and all insurance paperwork on your behalf.
              </p>
            </div>
            <a
              href="tel:+919369643922"
              className="shrink-0 px-6 py-3 gold-gradient text-navy font-sans font-semibold text-sm rounded-full hover:opacity-90 transition-opacity whitespace-nowrap"
            >
              Call Insurance Desk
            </a>
          </motion.div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mb-12">
            {insurers.map((name, i) => (
              ...
              >
                ...
                <p className="font-sans text-navy text-xs font-medium text-center leading-snug">
                  {name}
                </p>
              </motion.div>
            ))}
          ...
          >
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="font-serif text-xl text-navy">
                Documents Required for Cashless Surgery
              </h3>
            </div>
      ...
      <section ref={faqRef} className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <div className="w-16 h-0.5 gold-gradient mx-auto mb-5" />
            <p className="font-sans text-gray-500 max-w-xl mx-auto text-sm leading-relaxed">
              Can't find what you're looking for? Call us directly and we'll be
              happy to help.
            </p>
          </motion.div>

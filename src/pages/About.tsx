...
const infraImages = [
  ...
  },
  {
    ...
    label: "Reception & Patient Lounge",
  },
];
      ...
      <div className="bg-navy pt-28 pb-16 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <h1 className="font-serif text-4xl md:text-5xl text-white leading-tight mb-4">
            About{" "}
            <span className="text-gold-gradient">SR³ Care &amp; Cure</span>
          </h1>
          ...
          <p className="font-sans text-white/55 text-base leading-relaxed max-w-2xl mx-auto">
            A legacy built on clinical excellence, compassion, and an unwavering
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -right-6 bg-navy rounded-xl p-6 shadow-xl border border-gold/20"
            >
            ...
            <motion.div
              ...
              className="absolute -top-6 -left-6 bg-gold rounded-xl p-6 shadow-xl"
            >
              <p className="text-4xl font-serif text-navy font-bold">10k+</p>
              <p className="text-navy/70 font-sans text-sm mt-1">
                Patients Treated
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <h2 className="font-serif text-4xl text-navy leading-tight mb-5">
              A Legacy of{" "}
              <span className="text-gold-gradient">Clinical Excellence</span>
            </h2>
            <div className="w-16 h-0.5 gold-gradient mb-6" />
            <p className="font-sans text-gray-600 leading-relaxed mb-5">
              SR³ ENT &amp; Surgical Centre was founded with a singular mission:
              to bring world-class specialist healthcare to the people of
              Lucknow and the surrounding regions of Uttar Pradesh. What began
              as a dedicated ENT practice has grown into a comprehensive
              multispecialty centre trusted by over 10,000 families.
            </p>
            <p className="font-sans text-gray-600 leading-relaxed mb-8">
              We believe that excellent healthcare is a right, not a privilege.
              Every patient who walks through our doors receives the same level
              of meticulous, compassionate, and evidence-based care that we
            ...
            <Link
              to="/specialities"
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-navy text-white font-sans font-medium text-sm rounded-full hover:bg-navy-light transition-colors"
            >
          ...
          >
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-44 h-44 rounded-full overflow-hidden border-4 border-gold/30 mb-5 shadow-xl">
                <img
                  ...
                  alt="Dr. Samvartika – Director"
                  className="w-full h-full object-cover object-top"
                />
              </div>
              <h3 className="font-serif text-xl text-white">Dr. Samvartika</h3>
              <p className="text-gold text-xs font-sans mt-1 tracking-wide">
                Director &amp; Lead ENT Surgeon
              </p>
              <p className="text-white/40 text-xs font-sans mt-1">
                M.B.B.S., D.L.O. | Reg No. 56440
              </p>
            </div>
            ...
            <div className="lg:col-span-2">
              ...
              <blockquote className="font-serif text-xl md:text-2xl text-white leading-relaxed mb-6 italic">
                "At SR³, we do not merely treat conditions — we care for people.
                Every patient who comes to us carries their hopes, their fears,
                and the trust of their family. That trust is the greatest
                responsibility we hold, and it drives everything we do."
              </blockquote>
              <p className="font-sans text-white/50 text-sm leading-relaxed">
                With over fifteen years of practice in ENT and head-neck
                surgery, I founded SR³ to create a space where cutting-edge
                technology meets genuine human compassion. We are committed to
                being a centre of excellence that Lucknow can be proud of — not
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="font-sans text-gray-500 max-w-xl mx-auto text-sm leading-relaxed">
              Our clinic is equipped with the latest surgical suites, diagnostic
              units, and private wards designed for patient comfort and clinical
              precision.
            </p>
          </motion.div>
            ...
            {infraImages.map((img, i) => (
              ...
              >
                <img
                  src={img.src}
                  alt={img.label}
                  className={`w-full object-cover group-hover:scale-105 transition-transform duration-500 ${i === 0 ? "h-72" : "h-48"}`}
                />
                <div className="absolute inset-0 bg-gradient-to-t from-navy/70 via-transparent to-transparent" />
                <p className="absolute bottom-3 left-4 text-white font-sans text-xs font-medium tracking-wide">
                  {img.label}
                </p>
              </motion.div>
            ))}

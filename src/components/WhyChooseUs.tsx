...
const tickerText = 'Relief from chronic ailments  ·  Safe post-operative care  ·  Expert second opinions for complex cases  ·  Advanced diagnostics on-site  ·  Compassionate multispecialty care  ·  '

export default function WhyChooseUs() {
  const [ref, inView] = useInView()

  return (
    <section id="why-choose-us" className="pt-28 pb-0 bg-charcoal overflow-hidden" ref={ref}>
      <div className="max-w-7xl mx-auto px-6 pb-28">
        ...
        >
          <p className="text-gold tracking-[0.3em] text-xs font-sans uppercase mb-4">Why SR³</p>
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-start">
          ...
          >
            <div className="col-span-2 rounded-2xl overflow-hidden border border-white/8 h-56">
              <img src={images[0]} alt="Modern medical equipment" className="w-full h-full object-cover" />
            </div>
            <div className="rounded-2xl overflow-hidden border border-white/8 h-44">
              <img src={images[1]} alt="Advanced diagnostics" className="w-full h-full object-cover" />
            </div>
            <div className="rounded-2xl overflow-hidden border border-white/8 h-44">
              <img src={images[2]} alt="Clean clinical environment" className="w-full h-full object-cover" />
            </div>
          </motion.div>
            ...
            {features.map((f, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-sans text-white/50 text-sm leading-relaxed">{f.desc}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
      ...
      <div className="w-full gold-gradient py-4 overflow-hidden">
        <div className="ticker-track">
          ...
          {[tickerText, tickerText].map((t, idx) => (
            <span key={idx} className="text-navy font-sans font-semibold text-sm tracking-wide whitespace-nowrap px-6">
              {t}
            </span>
          ))}
        </div>

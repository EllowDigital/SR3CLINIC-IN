      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="font-sans text-gray-500 max-w-xl mx-auto text-sm leading-relaxed">
            A multidisciplinary team of fellowship-trained specialists committed
            to delivering the highest standard of care.
          </p>
        </motion.div>
          ...
          {doctors.map((doc, i) => (
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                />
                <div
                  className={`absolute inset-0 bg-gradient-to-t ${doc.color} via-transparent to-transparent`}
                />
              </div>

              {/* Info */}
              <div className="p-6">
                <h3 className="font-serif text-xl text-navy leading-snug mb-1">
                  {doc.name}
                </h3>
                <p className="font-sans text-gold text-xs font-semibold tracking-wide uppercase mb-1">
                  {doc.role}
                </p>
